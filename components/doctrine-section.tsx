export default function DoctrineSection() {
  return (
    <section id="doctrine" className="px-6 py-24 max-w-7xl mx-auto border-b border-gray-800">
      <h2 className="text-5xl font-bold tracking-tight uppercase mb-16 text-left">OPERATIONAL DOCTRINE</h2>
